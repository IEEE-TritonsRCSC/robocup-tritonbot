...
class Plotter:
    ...
    def extractVelocities(self, expected, actual):
        ...
        for i in range(4):
            expectedSpeed_b = 0
            for j in range(16):
                expectedSpeed_b += expected[16*i + 16 + j] # This line should work as expected
            expectedVelocities.append(twos_comp(int(str(expectedSpeed_b), 2), len(str(expectedSpeed_b))))
        ...
        for i in range(4):
            ...
            actualVelocities.append(twos_comp(int(str(actualSpeed_b), 2), len(str(actualSpeed_b))))
